...
localStorage.setItem("#¶bookingListID¶#master#¶bookingListID¶#","#¶bookingListID¶#master#¶bookingListID¶#");
...
if(localStorage.getItem("#¶bookingListID¶#"+bookingListID+"#¶bookingListID¶#")){
var length=(getMaxEntry(bookingListID)+1)||getBookingListAttribute(bookingListID,"length");
addBookingListAttribute(bookingListID, "entry"+length, userID+","+userBookingID);
incrementBookingListLength(bookingListID);
if(!(bookingListID=="master"))addUserBookingToList("master",userID,userBookingID);
